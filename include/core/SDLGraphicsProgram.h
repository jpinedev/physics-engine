...
/**
 * SDL Framework starter code from Mike Shah.
 */
    ...
    : screenWidth(w), screenHeight(h)
{
    ...
    else
    {
        ...
        gWindow = SDL_CreateWindow(
            "Lab", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED,
    ...
    // SDL_LogSetAllPriority(SDL_LOG_PRIORITY_WARN); // Uncomment to enable
    // extra debug support!
